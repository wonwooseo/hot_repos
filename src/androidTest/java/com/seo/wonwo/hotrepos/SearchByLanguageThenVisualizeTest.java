...
public class SearchByLanguageThenVisualizeTest {

    @Rule
    public ActivityTestRule<Search> mActivityTestRule = new ActivityTestRule<>(Search.class);

    @Test
    public void searchByLanguageThenVisualizeTest() {
        ...
        ViewInteraction appCompatCheckedTextView = onView(
                allOf(withId(android.R.id.text1), withText("Language"), isDisplayed()));
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(ViewMatchers.withId(com.seo.wonwo.hotrepos.R.id.search_editText), withText("java"),
                        withParent(allOf(ViewMatchers.withId(com.seo.wonwo.hotrepos.R.id.container),
                                withParent(withId(android.R.id.content)))),
                        isDisplayed()));
